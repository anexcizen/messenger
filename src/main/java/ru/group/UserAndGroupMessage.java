...
public class UserAndGroupMessage extends Message {
    ...
    public static UserAndGroupMessage[] getAllMessages() {
        UserAndGroupMessage[] messages = {new UserAndGroupMessage("Тимлид Анита", "анита, когда зарплата", "25 ноября", "18:01", "Вы"),
                ...
                new UserAndGroupMessage("Инфа проект", "Давайте в среду начнём", "25 ноября", "18:15", "Диана"),
                new UserAndGroupMessage("Инфа проект", "Да вы че", "25 ноября", "18:15", "Кристина"),
                new UserAndGroupMessage("Инфа проект", "Работайте работайте", "25 ноября", "18:16", "Анита")};
        return messages;
    }
}
