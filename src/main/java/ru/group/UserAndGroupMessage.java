...
public class UserAndGroupMessage extends Message {
    ...
    public static UserAndGroupMessage[] getAllMessages() {
        UserAndGroupMessage[] messages = {new UserAndGroupMessage("Тимлид Анита", "анита, когда зарплата", "25 ноября", "18:01", "Вы"),
                ...
                new UserAndGroupMessage("Диана", "Привет!приходи ко мне пить чай)", "24 ноября", "18:06", "Диана"),
                new UserAndGroupMessage("Диана", "Уже бегу,конфеты принести???", "24 ноября", "18:06", "Вы"),
                new UserAndGroupMessage("Диана", "Конечно, и печенье тоже захвати, и кружку не забудь!", "24 ноября", "18:06", "Диана"),
                new UserAndGroupMessage("Диана", "Оки", "24 ноября", "18:06", "Вы"),
                ...
                new UserAndGroupMessage("Инфа проект", "ЗАВТРА ОСТАЕМСЯ ПОСЛЕ ПАР!НЕ ЗАБУДЬТЕ ВЗЯТЬ С СОБОЙ НОУТЫ!!!!", "25 ноября", "18:15", "Диана"),
                ...
                new UserAndGroupMessage("рабы", "Предлагаю завтра с ней лично разобраться", "25 ноября", "18:15", "Диана"),
                ...
                new UserAndGroupMessage("ДУшнилы", "Да,купи,пожалуйста,шоколадку милку и чай зеленый любой)))", "23 ноября", "17:35", "Анита"),
                new UserAndGroupMessage("ДУшнилы", "И мне тоже шоколадку можно,пожалуйста", "23 ноября", "17:35", "Алёнка"),
                new UserAndGroupMessage("ДУшнилы", "А мне мороженое шоколадное, пожалуйста пожалуйста", "23 ноября", "17:35", "Диана"),
                new UserAndGroupMessage("ДУшнилы", "Окей,все куплю!", "23 ноября", "17:36", "Вы"),
                new UserAndGroupMessage("ДУшнилы", "Спасибооо", "23 ноября", "17:37", "Диана"),
                new UserAndGroupMessage("ДУшнилы", "Большое спасибо)))", "23 ноября", "17:38", "Анита"),
                new UserAndGroupMessage("ДУшнилы", "Спасибо)", "23 ноября", "17:38", "Анита"),
