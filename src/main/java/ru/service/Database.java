...
public class Database {
    public static User anita = new User("Тимлид Анита", "В сети", "босс", "12.07.2019", "+7800553535", "12.12.2007"); // pppppp
    public static User alena = new User("Алёна", "14:25", "айпадкид", "08.11.2020", "+7800663535", "09.09.2007");
    public static User diana = new User("Вы", "В сети", "танцуй танцулька", "15.12.2019", "+7800773535", "12.04.2007");
    ...
    public static UserChat[] chats = {new UserChat(anita), new UserChat(alena), new UserChat(kristina)};
}
