...
public class Database {
    ...
    public static Group[] groups = {new Group("Инфа проект",4,  new String[]{anita.userName, alena.userName, diana.userName, kristina.userName}), new Group("рабы", 3, new String[]{alena.userName, diana.userName, kristina.userName}), new Group( "ДУшнилы", 3, new String[]{anita.userName, alena.userName, diana.userName})};
